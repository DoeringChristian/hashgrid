...
void cuda_load_kernels() {
  ...
  cuGetErrorString =
      decltype(cuGetErrorString)(jit_cuda_lookup("cuGetErrorString"));
  cuModuleLoadData =
      decltype(cuModuleLoadData)(jit_cuda_lookup("cuModuleLoadData"));
  cuModuleGetFunction =
      decltype(cuModuleGetFunction)(jit_cuda_lookup("cuModuleGetFunction"));
  cuCtxPushCurrent =
      decltype(cuCtxPushCurrent)(jit_cuda_lookup("cuCtxPushCurrent_v2"));
  cuCtxPopCurrent =
      decltype(cuCtxPopCurrent)(jit_cuda_lookup("cuCtxPopCurrent_v2"));
  cuCtxSynchronize =
      decltype(cuCtxSynchronize)(jit_cuda_lookup("cuCtxSynchronize"));
  cuLaunchKernel =
      decltype(cuLaunchKernel)(jit_cuda_lookup("cuLaunchKernel_ptsz"));
